      ...
      <div className=" w-full h-full p-5 rounded-2xl backdrop-blur-sm bg-blue-600/30 border-2 border-blue-600 flex flex-col items-center">
        ...
        <div className=" w-full h-full mt-5 py-5 px-7 bg-white rounded-2xl overflow-x-hidden overflow-y-auto">
          ...
          {inputFieldKeys.map((inputKey) => (
           ...
           <button
            onClick={() => navigate("/requests-without-reviewer-details")}
            className=" absolute top-4 right-4 w-64 h-14 bg-gradient-to-r from-blue-600 to-blue-800 bg-blue-600/30 border-1 border-blue-600 rounded-lg shadow-lg hover:shadow-xl flex flex-col items-center justify-center text-white"
          >
